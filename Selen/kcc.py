...
def main():
    ...
    chrome_driver, wait = cchrome(r"C:\Users\shita\Projects\gitted\Selen\chromedriver118.exe", r"C:\Users\shita\appdata\local\chromium-118\application\chrome.exe")
    ...
    steps = log_on(chrome_driver, wait)
    steps.gmail()
    # ERROR WITHIN LAULIMA
    steps.laulima(5)
    steps.opening_classes()
    steps.star()
    kcc_library(chrome_driver, wait)
